...
console.log("############## Account ##############");
const account = new Account_1.Account(webUser1, cus1.getId(), cus1.getAddress(), cus1.getPhone(), cus1.getEmail(), '1', 'London', false, 'open', 'no');
console.log(account);
console.log(account.getId());
console.log("############## ShoppingCart ##############");
const shoppingcart = new ShoppingCart_1.ShoppingCart(webUser1, cus1.getId(), cus1.getAddress(), cus1.getPhone(), cus1.getEmail(), account.getId(), account.getBilling_address(), account.getIs_closed(), account.getOpen(), account.getClosed(), 'last month', [LineItem]);
console.log(shoppingcart);
