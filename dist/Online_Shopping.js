...
const shoppingcart = new ShoppingCart_1.ShoppingCart('last month', [line1, line2]);
...
console.log("############## Account ##############");
const account = new Account_1.Account(webUser1, '1', 'London', false, 'open', null, cus1.getId(), cus1.getAddress(), cus1.getPhone(), cus1.getEmail());
console.log(account);
